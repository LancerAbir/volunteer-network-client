...
const Register = () => {
    ...
    useEffect(() => {
        fetch("https://whispering-crag-01019.herokuapp.com/volunteers")
            .then((res) => res.json())
    ...
    const desValueHandler = () => {
        ...
        fetch("https://whispering-crag-01019.herokuapp.com/addEvents", {
                method: "POST",
                headers: {
        ...
        fetch("https://whispering-crag-01019.herokuapp.com/allUser", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    return ( <
        ...
        div className = "row" >
        <
        div className = "col-md-6 offset-md-3" > { /* <!--  Root Logo --!> */ } <
        ...
        <
        div className = "form-group date-picker" > { /* <!--  Date Picker --!> */ } <
        ...
        Link to = "/events" >
        <
        button onClick = { desValueHandler }
